...
["57FX", "http://baiduyun.57fx.cn/so-result.html?keyword={key}"],
["网盘搜", "http://www.wangpansou.cn/s.php?wp=0&ty=gn&op=gn&q={key}"],
["盘多多", "http://www.panduoduo.net/s/name/{key}"],
["云搜", "http://www.bdyunso.com/search-all-{key}-1/"],
["BT搜搜", "http://www.btsoso.info/search/{key}_ctime_1.html"],
["蜘蛛磁力", "http://www.zhizhucili.org/so/{key}-first-asc-1?f=h"],
["搜啦", "http://www.bdsola.com/search.php?kw={key}&searchType=ALL"],
["逛电驴", "http://verycd.gdajie.com//find.htm?keyword={key}"],
["驴客", "http://www.ed2kers.com/index.php/Index/search?keyword={key}"]]],
code: ["code", "编程", [
