...
["热搜", "/fav?key={key}"],
["头条", "https://www.toutiao.com/search/?keyword={key}"],
["微信", "http://weixin.sogou.com/weixin?type=2&query={key}"],
...
video: ["video", "视频", [
["爱奇艺", "http://so.iqiyi.com/so/q_{key}"],  
["腾讯", "https://v.qq.com/x/search/?q={key}"],
["优酷", "http://so.youku.com/search_video/q_{key}"],
["搜狐", "https://so.tv.sohu.com/mts?box=1&wd={key}"],  
["百度", "http://video.baidu.com/v?ct=301989888&rn=20&pn=0&db=0&s=7&word={key}&ie=utf-8"],
["搜狗", "http://v.sogou.com/v?query={key}"],
["哔哩", "http://search.bilibili.com/all?keyword={key}"]
]],
mp3: ["mp3", "音乐", [
...
["酷狗", "http://www.kugou.com/yy/html/search.html#searchType=song&searchKeyWord={key}"],
["酷我", "http://sou.kuwo.cn/ws/NSearch?type=all&key={key}"]
]],
pic: ["pic", "图片", [
["百度", "http://image.baidu.com/i?tn=baiduimage&ct=201326592&lm=-1&cl=2&word={key}&t=12"],
["搜狗", "http://pic.sogou.com/pics?query={key}"],
["必应", "https://cn.bing.com/images/search?q={key}"],
...
["豆瓣", "https://www.douban.com/search?q={key}"],
["鸠摩", "https://www.jiumodiary.com/?q={key}"],
["书问", "https://www.bookask.com/s/kw_{key}.html"],
["搜狗", "http://www.sogou.com/web?query=filetype%3Aall+{key}&filetype=all"],
["爱问", "http://ishare.iask.sina.com.cn/search/0-0-all-1-default?cond={key}"],
...
["知乎", "https://www.zhihu.com/search?type=content&q={key}"],
["库问", "http://www.koovin.com/?q={key}"],
["新浪", "https://iask.sina.com.cn/search?searchWord={key}"],
["天涯", "http://wenda.tianya.cn/search.jsp?q={key}"],
['搜狗', 'https://www.sogou.com/sogou?query={key}'],
['智库', 'https://doc.mbalib.com/search?q={key}'],
["谷歌学术", "http://ac.scmor.com/"],
["必应学术", "https://cn.bing.com/academic/search?q={key}"],
["百度学术", "http://xueshu.baidu.com/s?wd={key}"],
["学术搜素", "http://scholar.chongbuluo.com"]
]],
pan: ["pan", "网盘", [
// ["磁力福利", "http://cilifuli.cc/{key}/1-0-0.html"],
["磁力吧", "https://www.ciliba.org/s/{key}.html"],
["磁力王", "https://www.ciliwang.club/list.html?keyword={key}&sort=hot"],
["天天磁力", "http://www.ttcili8.com/s/{key}.html"],
["磁力狐", "https://www.cupfox.com/?type=video&key={key}"],
// ["磁力猫", "https://www.cilimao.me/search?word={key}"],   
