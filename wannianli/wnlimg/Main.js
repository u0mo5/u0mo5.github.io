...
function drawCld(SY,SM) {
	...
	GZ.innerHTML ='<a href="http://www.52fangjia.cn" target=_blank><span style="font-size: 1pt">&copy;我爱放假网</span></a>&nbsp;&nbsp;&nbsp;&nbsp; <font color=#FFCC00>●</font>&nbsp;<a onmouseout="hidetip2()" onmouseover=showtip2(this,event,"'+'公元'+SY+'年'+(SM+1)+'月","0","'+SM+'") href="#">'+ yDisplay+'年'+'</a> <font color=#FFCC00>●</font>&nbsp;'+Animals[(SY2-4)%12]+'年[农历' + cyclical(SY2-1900+36)+'年]' +'</a>&nbsp;<img src="wnlimg/' + ((SY2-4)%12+1) +'.gif">&nbsp;' ;
