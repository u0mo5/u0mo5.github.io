        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="<{$sys.subform}>" method="post">
                  ...
                  <div class="th">
                    <div class="form">
                    	<input type="button" value="添加搜索引擎关键字" onClick="location.href='?c=search_keyword&a=search_keyword_add&classid=<{$classid}>'" />&nbsp;
                ...
                <{foreach from=$data item=v key=k}>
                    ...
                    <td><{$v.classname}></td>
                    <td><{$v.url}></td>
                    <td><a href="?c=search_keyword&a=search_keyword_operate&classid=<{$v.class}>&id=<{$v.id}>">删除</a></td>
                    <td><a href="?c=search_keyword&a=search_keyword_edit&id=<{$v.id}>">修改</a></td>
                    </tr>
                <{/foreach}>
