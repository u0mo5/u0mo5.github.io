                  ...
                  <div class="table">
                        ...
                        <select id="alltopic" onchange="onChangeHandler(this);">                            
                            ...
                            <{foreach from=$class_list key = k item = parent}>
                                <optgroup label="<{$parent.name}>">
                                    <{if $parent.son}>
                                    <{foreach from=$parent.son item = i}>
                    ...
                    <tr>
                      ...
                      <{*   <td class="text-center">
                        ...
                        <td><font style="color:<{$i.namecolor}>;"><{$i.name}></font></td>
                        <td><div style="width:220px;" class="hideText" title="<{$i.url}>"><{$i.url}></div></td>
                        <td><a title="查看该分类所有网址" href="?c=zhuanti_site&classid=<{$i.class_id}>"><{$i.class_name}></a></td>
                        ...
                        <td><a href="?c=zhuanti_site&a=edit&action=modify&id=<{$i.id}>">修改</a></td>
                    </tr>
                    <{/foreach}>
                    </table>
                    <script type="text/javascript">
