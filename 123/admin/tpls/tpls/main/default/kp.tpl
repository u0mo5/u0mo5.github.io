...
<div id="wrap">
    ...
    <div id="hot"><{*名站上方广告*}><{foreach from = $advert_search_footer item = i}><a <{if $i.color=='#FF0000' || $i.color=='red'}>class="red"<{elseif $i.color=='#008000' || $i.color=='green'}>class="green"<{elseif $i.color=='#0000FF' || $i.color=='blue'}>class="blue"<{elseif $i.color!=''}>style="color:<{$i.color}>;"<{/if}> target="_blank" href="<{$i.link}>"><{$i.title}></a><{/foreach}></div>
    <div id="content">
    ...
    <div id="meta"><b class="rc-tp"><b></b></b>
        ...
        <li class="bd">
            ...
            <{/foreach}>
            <span class="more"><a href="<{$URL_HTML}>/catalog/<{$k}>.htm">更多 &raquo;</a></span>
        </li>
        <{/foreach}>
        <{*专题*}>
    ...
    <div id="fs">
        ...
        <b class="rc-bt"><b></b></b></div>
    <div id="footer">
        <div class="link"><a href="http://www.114la.com/114la/">关于114啦建站系统V1.15</a> | <a href="<{$URL}>/url-submit/">网站提交</a> | <a href="<{$URL}>/feedback">意见反馈</a> | <a href="http://www.114la.com/114la/">源码下载</a><br />
        </div>
        <div class="hr"></div>
