<?php /* Smarty version 2.6.25, created on 2016-02-18 15:27:27
         compiled from index_tool_edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'index_tool_edit.tpl', 17, false),)), $this); ?>
    ...
    <div class="container">
        <div id="main">
            <div class="con box-green">
                <form action="?c=index_tool&a=save" method="post">
...
"/>
                <div class="box-header">
                    <h4><?php if ($this->_tpl_vars['action'] == 'modify'): ?>修改<?php else: ?></>添加<?php endif; ?>工具</h4>
                </div>
                <div class="box-content">
                    <table class="table-font">
                        <tr>
                            <th class="w120">工具名称：</th>
...
" class="textinput w270" /><span style="margin-left:10px;">链接颜色：</span><span id="js_link_color" style="margin-right:10px;"></span><input id="js_test_input" name="color" type="hidden" value="<?php echo $this->_tpl_vars['data']['color']; ?>
" /></td>
                        </tr>
                        <tr>
                            <th>工具网址：</th>
...
" class="textinput w60"   onkeyup="value=value.replace(/[^\d]/g,'')" /></td>
                ...
                <div class="box-footer">
                    <div class="box-footer-inner">
                    	<input type="submit" value="提交" /></a> 或 <a href="?c=index_tool&a=index&classid=<?php echo $this->_tpl_vars['data']['class']; ?>
">取消</a>
                    </div>
                </div>
                </form>
