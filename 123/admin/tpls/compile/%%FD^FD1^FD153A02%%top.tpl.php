<?php /* Smarty version 2.6.25, created on 2017-07-11 13:12:18
            ...
            <div id="menu">
                    <div class="item">
                        <ul>
                            ...
                            <li><a href="?c=login&a=menu&id=10" target="menu" id="item10" onclick="Tabmenu(this,10);">城市导航</a></li>
                            ...
                            <li><a href="?c=login&a=menu&id=11" target="menu" id="item11" onclick="Tabmenu(this,11);">114啦联盟</a></li>
