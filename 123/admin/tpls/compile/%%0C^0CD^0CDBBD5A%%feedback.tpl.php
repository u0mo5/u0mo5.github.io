<?php /* Smarty version 2.6.25, created on 2016-11-06 06:24:34
         compiled from feedback.tpl */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>意见反馈 - <?php echo $this->_tpl_vars['sysname']; ?>
</title>
<link href="<?php echo $this->_tpl_vars['URL']; ?>
/feedback/images/style.css" rel="stylesheet" type="text/css" />
<script language="javascript" type="text/javascript" src="<?php echo $this->_tpl_vars['URL']; ?>
/feedback/images/jquery.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $this->_tpl_vars['URL']; ?>
/feedback/images/feedback.js"></script>
</head>
<body>
<div class="wrap">
	<div id="header">
    	...
    	<h1 class="logo"><a href="./" ><?php echo $this->_tpl_vars['sysname']; ?>
-意见反馈</a></h1>
    	<div id="menu">
        	<ul>
...
　&copy;2005-<script type="text/javascript">document.write(new Date().getFullYear());</script> . All Rights Reserved.
        </div>
</div>
