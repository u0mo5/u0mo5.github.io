    ...
    <tr>
        ...
        <td valign="top" width="100%">
        	...
        	<table  cellpadding="0" cellspacing="0" width="100%" height="100%">
                ...
                <tr>
                    <td valign="top" width="100%"><iframe src="?c=login&a=welcome" id="main" name="main" width="100%" height="100%" frameborder="0" scrolling="yes" style="overflow:visible;"></iframe></td><!--  ?c=login&a=welcome  -->
                </tr>
            </table>
