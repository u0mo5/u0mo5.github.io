<?php /* Smarty version 2.6.25, created on 2012-03-05 21:27:12
...
/public/home/base.css" rel="stylesheet" type="text/css" />
...
/" target="_parent" class="active">标准版</a> | <a href="<?php echo $this->_tpl_vars['URL']; ?>
/kp.html" target="_parent" onclick="Cookie.set('layout',1)">宽屏版</a></li>
...
;"<?php endif; ?>><?php echo $this->_tpl_vars['v']['name']; ?>
                        ...
                        <dd class="m"><a href="<?php echo $this->_tpl_vars['item']['url']; ?>
">更多 &raquo;</a></dd>
                    </dl>
                    <?php endforeach; endif; unset($_from); ?>
                </div>
...
/catalog/links.htm">更多 &raquo;</a></span>
    ...
    <div id="fs">
        ...
        <b class="rc-bt"><b></b></b></div>
    <div id="footer">
        <div class="link"><a href="http://www.114la.com/114la/">关于114啦建站系统V1.15</a> | <a href="/url-submit/">网站提交</a> | <a href="<?php echo $this->_tpl_vars['URL']; ?>
