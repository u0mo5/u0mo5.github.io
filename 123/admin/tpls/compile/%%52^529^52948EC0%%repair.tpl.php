<?php /* Smarty version 2.6.25, created on 2012-03-16 03:32:59
         compiled from repair.tpl */ ?>
...
?>
                    <tr>
                        <td><input type='checkbox' name='table_list[]' value='<?php echo $this->_tpl_vars['current_row']['Name']; ?>
' /></td>
                        <td><?php echo $this->_tpl_vars['current_row']['Name']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['zh_name']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['Engine']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['Rows']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['Data_length']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['Index_length']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['current_row']['Data_free']; ?>
</td>
