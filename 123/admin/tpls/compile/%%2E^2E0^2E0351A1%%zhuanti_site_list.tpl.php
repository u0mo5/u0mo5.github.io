<?php /* Smarty version 2.6.25, created on 2012-03-17 00:10:47
         compiled from zhuanti_site_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'zhuanti_site_list.tpl', 76, false),)), $this); ?>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=zhuanti_site&a=search" method="get">
                    <input type="hidden" name="c" value="zhuanti_site"/>
...
" id="keyword" name="keyword"/>
            	...
            	<form action="?c=zhuanti_site&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<?php echo $this->_tpl_vars['referer']; ?>
"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form">
                        <input type="button" value="添加网址" onclick="self.location='?c=zhuanti_site&a=edit&action=add'"/>&nbsp;
                        <?php if ($this->_tpl_vars['class_list']): ?>
                        <label for="alltopic">按分类查看</label>&nbsp;
                        <script type="text/javascript">
							var onChangeHandler = function(ele){
								window.location='?c=zhuanti_site&classid=' + ele.value;
							}
						</script>
                        <select id="alltopic" onchange="onChangeHandler(this);">                            
                        	<option onclick="self.location='?c=zhuanti_site'";>所有专题</option>
...
?>
                                <optgroup label="<?php echo $this->_tpl_vars['parent']['name']; ?>
">
                                    <?php if ($this->_tpl_vars['parent']['son']): ?>
...
'><?php echo $this->_tpl_vars['i']['name']; ?>
                        ...
                        <?php endif; ?>
                        &nbsp;&nbsp;<a href="?c=zhuanti_site">查看全部</a>&nbsp;
                       <!-- &nbsp;&nbsp;<a href="?c=zhuanti_site&inindex=1">查看在首页显示的站点</a>&nbsp;-->
                        &nbsp;&nbsp;<a href="?c=zhuanti_site&isend=1">查看过期站点</a>&nbsp;
                        </div>
                    </div>
...
" /></td>                 
                        <td><font style="color:<?php echo $this->_tpl_vars['i']['namecolor']; ?>
;"><?php echo $this->_tpl_vars['i']['name']; ?>
</font></td>
                        <td><div style="width:220px;" class="hideText" title="<?php echo $this->_tpl_vars['i']['url']; ?>
"><?php echo $this->_tpl_vars['i']['url']; ?>
</div></td>
                        <td><a title="查看该分类所有网址" href="?c=zhuanti_site&classid=<?php echo $this->_tpl_vars['i']['class_id']; ?>
...
<?php endif; ?></td>      
                        <td><a href="?c=zhuanti_site&a=edit&action=modify&id=<?php echo $this->_tpl_vars['i']['id']; ?>
">修改</a></td>
                    </tr>
                    <?php endforeach; endif; unset($_from); ?>
                    </table>
