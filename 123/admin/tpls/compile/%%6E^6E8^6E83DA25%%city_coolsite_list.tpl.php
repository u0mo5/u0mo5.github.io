<?php /* Smarty version 2.6.25, created on 2014-06-28 22:30:25
         compiled from city_coolsite_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'city_coolsite_list.tpl', 82, false),)), $this); ?>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
                <!--
            	<form action="?c=city_coolsite&a=search" method="get">
                    <input type="hidden" name="c" value="city_coolsite"/>
...
" id="keyword" name="keyword"/>
            	...
            	<form action="?c=city_coolsite&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<?php echo $this->_tpl_vars['referer']; ?>
"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form">
                        <input type="button" value="添加网址" onclick="self.location='?c=city_coolsite&a=edit&action=add'"/>&nbsp;
                        <?php if ($this->_tpl_vars['cityclass_list']): ?>
                        <label for="alltopic">按城市分类查看</label>&nbsp;
                        <script type="text/javascript">
							var onChangeHandler = function(ele){
								window.location='?c=city_coolsite&cityclass_id=' + ele.value + '&coolclass_id=<?php echo $this->_tpl_vars['coolclass_id']; ?>
';
							}
						</script>
                        <select id="alltopic" onchange="onChangeHandler(this);">                            
                        	<option onclick="self.location='?c=city_coolsite&coolclass_id=<?php echo $this->_tpl_vars['coolclass_id']; ?>
'";>所有名站</option>
                            <?php $_from = $this->_tpl_vars['cityclass_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['i']):
?>
                                    <option<?php if ($this->_tpl_vars['i']['id'] == $this->_tpl_vars['cityclass_id']): ?> selected="selected"<?php endif; ?> value='<?php echo $this->_tpl_vars['i']['id']; ?>
'><?php echo $this->_tpl_vars['i']['name']; ?>
                        ...
                        <label for="alltopic">按酷站分类查看</label>&nbsp;
                        <script type="text/javascript">
							var onChangeHandler1 = function(ele){
								window.location='?c=city_coolsite&coolclass_id=' + ele.value + '&cityclass_id=<?php echo $this->_tpl_vars['cityclass_id']; ?>
';
							}
						</script>
                        <select id="alltopic" onchange="onChangeHandler1(this);">                            
                        	<option onclick="self.location='?c=city_coolsite&cityclass_id=<?php echo $this->_tpl_vars['cityclass_id']; ?>
'";>所有名站</option>
                            <?php $_from = $this->_tpl_vars['coolclass_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['i']):
?>
                                    <option<?php if ($this->_tpl_vars['i']['id'] == $this->_tpl_vars['coolclass_id']): ?> selected="selected"<?php endif; ?> value='<?php echo $this->_tpl_vars['i']['id']; ?>
'><?php echo $this->_tpl_vars['i']['name']; ?>
</option>
                            <?php endforeach; endif; unset($_from); ?>
                        </select>&nbsp;
                        ...
                        &nbsp;&nbsp;<a href="?c=city_coolsite">查看全部</a>&nbsp;
                       <!-- &nbsp;&nbsp;<a href="?c=city_coolsite&inindex=1">查看在首页显示的站点</a>&nbsp;-->
                        &nbsp;&nbsp;<a href="?c=city_coolsite&isend=1">查看过期站点</a>&nbsp;
                        </div>
                    </div>
...
" /></td>                 
                        <td><a href="?c=city_coolsite&a=edit&action=modify&id=<?php echo $this->_tpl_vars['i']['id']; ?>
...
"><?php echo $this->_tpl_vars['i']['url']; ?>
                        ...
                        <td><a title="查看该分类所有网址" href="?c=city_coolsite&cityclass_id=<?php echo $this->_tpl_vars['i']['cityclass_id']; ?>
"><?php echo $this->_tpl_vars['i']['cityclass_name']; ?>
</a></td>
                        <td><a title="查看该分类所有网址" href="?c=city_coolsite&coolclass_id=<?php echo $this->_tpl_vars['i']['coolclass_id']; ?>
"><?php echo $this->_tpl_vars['i']['coolclass_name']; ?>
</a></td>
