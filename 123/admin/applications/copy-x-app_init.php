...
// 静态 HTML
defined('HOST') || define('HOST', 'http://u0mo5.sinaapp.com/?x=link' );
$path_info = pathinfo($_SERVER['PHP_SELF']);
$path_x = rtrim(strtr(dirname($path_info['dirname']), array('\\' => '/')), '/');
if(mod_config::get_one_config('yl_linkurl')) defined('URL') || define('URL', mod_config::get_one_config('yl_linkurl'));
else defined('URL') || define('URL', 'http://u0mo5.sinaapp.com/?x=link' . $path_x);
